  ...
  <div class="row">
    <div class="col" id="divesq">
      <h3 class="text-left">Livro do mês:</h3>
          <a href="clubeChicklit.php">
            <img src="https://m.media-amazon.com/images/I/419Zqe2B7uL.jpg" width="200px" height="300px">
          </a>
          <div id="btnBaixar">
          <a href="livros/mial.pdf" download="livrodomes"><button class="btn btn-outline-dark" type="button">Fazer download</button></a>
      </div>
        </div>
    <div class="col" id="divdir">
<div>
<h3 class="text-left">Descricão:</h3>
<p class="text-break text-start">A breathtaking new novel about a young woman whose fate hinges on the choice 
  she makes after bumping into an old flame; in alternating chapters, we see two possible 
  scenarios unfold—with stunningly different results.</p>
